export default {
  ...
  settings: {
    ...
    faq: {
      ...
      monthlyYearly: {
        question: 'サブスクリプションに登録またはアップグレードするにはどうすればいいですか？',
        answer:
          '設定のサブスクリプション＆クレジットをタップしてプランを選択または変更してください。いつでも無料から月額または年額にアップグレードできます — または月額から年額に切り替えることもできます。正確な手順は各アプリストアのルールによって異なります。データは完全に保持されます。設定のBackup & Restoreでデータを追加でバックアップすることもできます。',
      },
      data: {
      ...
      trialAfterData: {
        question: 'お試し期間後、アプリはどうなりますか？',
        answer:
          'お試し期間後も読み取り専用モードでアプリを引き続き使用し、保存済みのデータを閲覧できます。新しい支出を追加したり領収書をスキャンしたりするには月額または年額プランが必要です。',
      },
      ai: {
      ...
      scanCost: {
        ...
        answer:
          'クレジットはSnapomatのAI分析の通貨です。領収書の写真1枚につき1クレジット消費します。手動入力は無料です。サブスクライバーとして毎月自動的に250クレジットが付与されます。',
      },
      budget: {
