  ...
  settings: {
    ...
    faq: {
      ...
      monthlyYearly: {
        ...
        answer:
          'はい。正確な手順は各アプリストアのルールによって異なりますが、ほとんどの場合、ストアの設定から直接サブスクリプションを管理して年額プランにアップグレードできます。データは完全に保持されます。Backup & Restore でデータを追加でバックアップすることもできます。',
      },
      data: {
      ...
      trialAfterData: {
        ...
        answer:
          'お試し期間後も保存済みのデータは引き続き閲覧できます — アプリは読み取り専用モードで開いたままです。新しい支出を追加したり領収書をスキャンしたりするには月額または年額プランが必要です。',
      },
      ai: {
